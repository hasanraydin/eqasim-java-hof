...
public class IDFModeParameters extends ModeParameters {
	...
	public static IDFModeParameters buildDefault() {
		...
		// Car
		parameters.car.alpha_u = 0.4;
		parameters.car.betaTravelTime_u_min = -0.042431;

		// Car passenger
		parameters.idfCarPassenger.alpha_u = -1.4;
		...
		// Bike
		parameters.bike.alpha_u = -0.5;
		parameters.bike.betaTravelTime_u_min = -0.093485;

		// Walk
		parameters.walk.alpha_u = 1.8;
		...
		parameters.drt.betaAccessEgressTime_u_min = -0.2;		    //base value = -0.080
