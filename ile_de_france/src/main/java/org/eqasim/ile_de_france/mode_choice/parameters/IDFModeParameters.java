...
public class IDFModeParameters extends ModeParameters {
	...
	public static IDFModeParameters buildDefault() {
		...
		parameters.drt.betaTravelTime_u_min = -0.1;					//base value = -0.2
		parameters.drt.betaWaitingTime_u_min = -0.4;				//base value = -0.1
		parameters.drt.betaAccessEgressTime_u_min = -0.00;		//base value = -0.0804
