...
public class IDFModeParameters extends ModeParameters {
	...
	public static IDFModeParameters buildDefault() {
		...
		parameters.drt.betaTravelTime_u_min = -0.28;			    //base value = -0.2
		parameters.drt.betaWaitingTime_u_min = -0.22;				//base value = -0.1
		parameters.drt.betaAccessEgressTime_u_min = -0.22;		    //base value = -0.0804
