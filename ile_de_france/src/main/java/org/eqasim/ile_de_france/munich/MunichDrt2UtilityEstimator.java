...
public class MunichDrt2UtilityEstimator implements UtilityEstimator {

    private final IDFModeParameters modeParameters;
    private final DrtPredictor drtPredictor;

    @Inject
    public MunichDrt2UtilityEstimator(IDFModeParameters modeParameters, DrtPredictor drtPredictor) {
