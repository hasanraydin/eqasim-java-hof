...
public class MunichDrt1UtilityEstimator implements UtilityEstimator {

    private final IDFModeParameters modeParameters;
    private final DrtPredictor drtPredictor;

    @Inject
    public MunichDrt1UtilityEstimator(IDFModeParameters modeParameters, DrtPredictor drtPredictor) {
